...
class ForgotPass extends StatefulWidget {
  const ForgotPass({Key? key, required this.color}) : super(key: key);
  ...
  void _changePassword(String pass) async {
    ...
    user!.updatePassword(pass).then((_) {
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Đổi pass thành công')));
    });
  }
      ...
      body: Center(
        child: Column(
          ...
          children: [
                  ...
                  child: TextField(
                      ...
                      decoration: InputDecoration(
                          ...
                          enabledBorder: OutlineInputBorder(
                              borderSide:
                                  BorderSide(width: 2, color: widget.color)),
            ...
            InkWell(
                onTap: () async {
                  if (txtCurrPass.text.isEmpty ||
                      txtNewPass.text.isEmpty ||
                      txtCheck.text.isEmpty) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                        content: Text(
                            'Mật khẩu mới cần ít nhất 8 kí tự, chứa ít nhất 1 chữ cái viết hoa và 1 kí tự đặc biệt')));
